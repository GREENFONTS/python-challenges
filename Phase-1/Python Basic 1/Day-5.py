...
3. Write a Python program to sum of three given integers.
 However, if two values are equal sum will be zero.

4. Write a Python program to sum of two given integers. 
However, if the sum is between 15 to 20 it will return 20.

5. Write a Python program that will return true if the two given 
integer values are equal or their sum or difference is 5.

6. Write a Python program to add two objects if 

both objects are an integer type.
...
9. Write a Python program to compute the future value of a 
