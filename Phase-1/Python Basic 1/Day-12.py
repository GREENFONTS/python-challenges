...
3. Write a Python program to extract the filename from a given path.

4. Write a Python program to get the effective group id, effective user id, real group id, 
a list of supplemental group ids associated with the current process.
Note: Availability: Unix.

5. Write a Python program to get the users environment.
